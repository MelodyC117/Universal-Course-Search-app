            ...
            <table style="width: 100%;background-color: black; opacity: 0.55; font-style:normal; margin-top: -10px; color: white;" border="1" cellspacing="5" cellpadding="5">
                <thead>
                    <tr>
                      ...
                      <th align="left">School Website</th>
                    </tr>
                </thead>
                <tbody>
                    <?php while ($row = $q->fetch()): ?>
                        <tr>
                            ...
                            <td align="left"><?php echo htmlspecialchars($row['School_Name']); ?></td>
                            <td><a href="<?php echo $row['School_Website']; ?>"><?php echo $row['School_Website']; ?></a></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
